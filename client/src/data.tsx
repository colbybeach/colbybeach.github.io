...
import JupiterVe from "./assets/JupiterVenturesLogoSquare.png";
...
export const projects: Project[] = [
  {
    ...
    description: (
      <>
        Lead full-stack developer for one of our clients where I have been able
        to add new features and refactor their web application to ensure proper
        scalability, as well as being able to support a 50% uptick in the number
        of users and clients on their end. This is built in React, Typescript,
        Node, Nest.JS, and hosted on AWS.
        <br /> <br />
        Lead architect and full-stack developer on a client project where I
        built a new Typescript application to improve and speed up parts of
        their existing sales and engineering workflows. This project has allowed
        their existing processes to go from taking weeks to only a few seconds,
        transforming engineering and business critical logic into a simple
        button click.
        <br /> <br />
        Lead full-stack developer on an internal employee health and wellness
        tracking application. I built this project from the ground up, and
        designed and implemented it to support millions of data points while
        handling daily traffic from our entire company. Built with React,
        Typescript, Node, and PostgreSQL, hosted with GCP. <br /> <br />
        Led a team of first-year interns and new associate developers as they
        built a new internal application for Jahnel Group together.
      </>
    ),
    skills: [
...

  {
    ...
    description: (
      <>
        At MLAI I am a lead software engineer reviewing all code changes to
        ensure quality and scalability, as well as completing new feature
        development to help our platform improve each day.
        <br /> <br />
        MorningLine.ai is a cutting-edge horse racing platform designed to
        provide advanced predictive analytics and data-driven insights for horse
        betting enthusiasts.
      </>
    ),
    skills: [
  ...
  {
    title: "Jupiter Ventures",
    dates: "Decemebr 2023 - Present",
    shortDescription: "AI & Technology Strategy Consulting",
    role: "Founder & CEO",
    description: (
      <>
        Jupiter Ventures is a technology consulting company founded to help aid
        businesses in digital transformation, existing technology auditing, and
        software development. <br /> <br />
        We currently lead the development of a new full-stack application for a
        manufacturing client, enabling real-time views and alerts into the
        critical infrastructure of their plants . We estimate that this product
        will save our client upwards of 12 million dollars a year.
      </>
    ),
    skills: [
      <FaReact className="w-5 h-5" />,
  ...
  },
  {
    ...
    description: (
      <>
        At Cocobolo Group/Perfecti, I was a software developer for the 2022/2023
        winter/spring term.
        <br /> <br />I worked primarily as the lead developer for the web
        development team where I built a business dashboard to coincide with two
        startup iOS applications in the restaurant space using React.JS,
        Express/Node.JS, Firebase, and Tailwind CSS. <br /> <br />I also worked
        on their two iOS applications using Swift/SwiftUI, and Firebase.
      </>
    ),
    skills: [
  ...
  },
  {
    ...
    description: (
      <>
        QuantBuilder.io is a custom-built no-code strategy builder for aspiring
        quantitative stock traders. Beginners are able to learn the basics of
        quantitative trading alongside building their own algorithmic strategies
        without writing a single line of code or having any finance background.
        Users can also share their strategies with the entire platform to learn
        together. Built with React/Django/GCP.
      </>
    ),
    skills: [
