...
export default function HomePage() {
  ...
  const { data: experienceData } = useQuery(["experienceQuery"], () =>
    getExperiences()
  );
    ...
    <>
      ...
      <div className="sm:px-16 px-4 pt-32 pb-8">
        <div className="w-full flex md:flex-row flex-col items-center justify-around ">
          <div className="flex flex-col md:w-1/2 md:gap-8 md:items-start items-center">
            <h1 className="text-7xl md:mb-0 mb-10">
              <Typewriter
                options={{
                  strings: ["Who...me?"],
                  autoStart: true,
            ...
            <div className="md:hidden flex mt-4 gap-4 mb-5">
              <button className="btn btn-primary w-fit ">Contact Me</button>
              <a
                className="btn btn-ghost w-fit "
                href="https://github.com/colbybeach"
                target="_none"
              >
                Github
              </a>
              <a
                className="btn btn-ghost w-fit"
                href="https://www.linkedin.com/in/colby-beach-57b66017b/"
                target="_none"
              >
                LinkedIn
              </a>
            ...
            <div className="flex gap-2 pb-2">
              <button className="btn btn-primary w-fit md:flex hidden">
                Contact Me
              </button>
              <a
                className="btn btn-ghost w-fit md:flex hidden"
                href="https://github.com/colbybeach"
                target="_none"
              >
                Github
          ...
          <div className="w-1/2 min-w-[400px] flex justify-end">
        ...
        <div className="md:hidden flex flex-col items-center w-full justify-center px-2 mt-6 text-center">
          <p className="">
            Hello! My name is Colby, and I am super passionate about
            programming, buisness, and leadership. I am currently a software
          ...
          <div className="lg:hidden">
            ...
            <div className="shadow-2xl bg-neutral flex flex-col gap-y-5 p-10 mt-10 rounded-xl">
              {skillData && (
                <>
                  <SkillLevel
                    data={skillData[validCategories[selectedSkillIndex]]}
                    level="lead"
                  />
                  <SkillLevel
                    data={skillData[validCategories[selectedSkillIndex]]}
            ...
            <div className="shadow-xl bg-neutral flex flex-col justify-around p-10 w-2/5 rounded-xl">
              ...
              {skillCategories.map((category, index) => (
                <button
                  key={index}
                  className={`btn ${
                    selectedSkillIndex === index ? "btn-primary" : "btn-outline"
                  }`}
        ...
        <div className="flex flex-col gap-y-10 mt-20">
            ...
            <div className="flex lg:justify-between w-full lg:flex-row flex-col items-center gap-y-10">
              <div className="flex flex-col gap-y-2 lg:w-1/2">
                <h4 className="text-lg">
                  {experienceData[selectedExperience].experience} (
              ...
              <ImageCarousel
                images={experienceData[selectedExperience].images}
              />
            </div>
          ) : (
            ""
          ...
          <div className="lg:flex w-full justify-between hidden">
            <button
              className={`btn ${
                selectedExperience === 2 ? "btn-primary" : "btn-outline"
              }`}
            ...
            <button
              className={`btn ${
                selectedExperience === 3 ? "btn-primary" : "btn-outline"
              }`}
            ...
            <button
              className={`btn ${
                selectedExperience === 1 ? "btn-primary" : "btn-outline"
              }`}
            ...
            <button
              className={`btn ${
                selectedExperience === 0 ? "btn-primary" : "btn-outline"
              }`}
              ...
              <div className="flex lg:justify-between w-full lg:flex-row flex-col items-center gap-y-10">
                ...
                <div className="flex flex-col gap-y-2 lg:w-1/2 lg:text-end">
                  <h4 className="text-lg">
                    ...
                    {projectData[selectedProject].dates})
                  </h4>
                  <p className="font-light text-sm">
